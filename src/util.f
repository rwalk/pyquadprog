...
c     using the factors computed by dpotrf.
c
...
c     on return
c
c        a       if dpotrf was used to factor  a  then
...
c        and if dpoco or dpotrf has set info .eq. 0 .
c
...
c     system a * x = b
c     using the factors computed by dpoco or dpotrf.
c
c     on entry
c
c        a       double precision(lda, n)
c                the output from dpoco or dpotrf.
c
c        lda     integer
c                the leading dimension of the array  a .
c
